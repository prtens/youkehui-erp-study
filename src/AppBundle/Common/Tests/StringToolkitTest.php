...
class StringToolkitTest extends BaseTestCase
{
    ...
    public function testPlainTwice()    //字符串截取第0-x位
    {
        ...
        $this->assertEquals($result, 'abc这是...');
    }
    ...
    public function testLtrimString()
    {
        $string = '/var/www/project/web/files/default/2017/04-04/2017404082923-7p08qf.png';
        $prefixString = '/var/www/project/web/files';
        $result = StringToolkit::ltrimString($string, $prefixString);
        $this->assertEquals('/default/2017/04-04/2017404082923-7p08qf.png', $result);
    }
}
