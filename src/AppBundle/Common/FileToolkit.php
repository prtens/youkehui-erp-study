...
class FileToolkit
{
    public static function validateFileExtension(File $file, $extensions = array())
    {
        ...
        if (preg_match('/\.('.preg_replace('/ +/', '|', preg_quote($extensions)).')$/i', $filename)) {
            return true;
        }
    ...
    public static function validateFileMaxSize(File $file, $maxSize)
    {
    ...
    public static function cropImage($filePath, $options)
    {
